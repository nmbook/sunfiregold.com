$(document).ready(function() {
  ...
  $('input.input_date').each(function() {
    ...
    for (var i = 1; i < 13; i++) {
      var select = (mo_selected ? false : today.getMonth() == i-1);
      if (select)
        mo_selected = true;
  ...
  $('input.input_dog').each(function() {
    ...
    $('#' + name + '_preview span.x').live('click', function() {
      is_set = false;
      $('#' + name + '_field').val('');
      $('#' + name + '_preview').remove();
    });
  ...
  $('input.input_ped').each(function() {
    ...
    $('#' + name + '_finder').live('click', function() {
      is_set = false;
      $('#' + name + '_field').val('');
      $('#' + name + '_preview').remove();
  ...
  $('input.input_k9data').each(function() {
    ...
    $('#' + name + '_remove, #' + name + '_preview span.x').live('click', function() {
      is_set = false;
      $('input[name='+name+']').val('');
      $('#' + name + '_field').val('');
      $('#' + name + '_break').remove();
